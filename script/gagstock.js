...
module.exports.config = {
  ...
  hasPermission: 0,
  usePrefix: false,
  aliases: ["gagstock", "stocktracker"],
  description: "Track Grow A Garden stock with favorites, global last seen, weather info, and more — Version 9.8.9.3 added features."
};

module.exports.execute = async function(senderId, args, pageAccessToken) {
